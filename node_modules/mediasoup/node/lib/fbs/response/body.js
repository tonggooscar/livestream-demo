...
const send_response_1 = require("../../fbs/data-consumer/send-response");
...
(function (Body) {
    ...
    Body[Body["DataConsumer_SendResponse"] = 30] = "DataConsumer_SendResponse";
    Body[Body["DataConsumer_SetSubchannelsResponse"] = 31] = "DataConsumer_SetSubchannelsResponse";
    Body[Body["DataConsumer_AddSubchannelResponse"] = 32] = "DataConsumer_AddSubchannelResponse";
    Body[Body["DataConsumer_RemoveSubchannelResponse"] = 33] = "DataConsumer_RemoveSubchannelResponse";
...
function unionToBody(type, accessor) {
    switch (Body[type]) {
        ...
        case 'DataConsumer_SendResponse': return accessor(new send_response_1.SendResponse());
...
function unionListToBody(type, accessor, index) {
    switch (Body[type]) {
        ...
        case 'DataConsumer_SendResponse': return accessor(index, new send_response_1.SendResponse());
