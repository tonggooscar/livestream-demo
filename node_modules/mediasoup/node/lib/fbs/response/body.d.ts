...
import { SendResponse } from '../../fbs/data-consumer/send-response';
...
export declare enum Body {
    ...
    DataConsumer_SendResponse = 30,
    DataConsumer_SetSubchannelsResponse = 31,
    DataConsumer_AddSubchannelResponse = 32,
    DataConsumer_RemoveSubchannelResponse = 33
}
