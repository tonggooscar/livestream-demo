...
const sctp_negotiated_capabilities_notification_1 = require("../../fbs/transport/sctp-negotiated-capabilities-notification");
...
(function (Body) {
    ...
    Body[Body["Transport_SctpNegotiatedCapabilitiesNotification"] = 3] = "Transport_SctpNegotiatedCapabilitiesNotification";
    Body[Body["Producer_SendNotification"] = 4] = "Producer_SendNotification";
    Body[Body["DataProducer_SendNotification"] = 5] = "DataProducer_SendNotification";
    Body[Body["Transport_TraceNotification"] = 6] = "Transport_TraceNotification";
    Body[Body["WebRtcTransport_IceSelectedTupleChangeNotification"] = 7] = "WebRtcTransport_IceSelectedTupleChangeNotification";
    Body[Body["WebRtcTransport_IceStateChangeNotification"] = 8] = "WebRtcTransport_IceStateChangeNotification";
    Body[Body["WebRtcTransport_DtlsStateChangeNotification"] = 9] = "WebRtcTransport_DtlsStateChangeNotification";
    Body[Body["PlainTransport_TupleNotification"] = 10] = "PlainTransport_TupleNotification";
    Body[Body["PlainTransport_RtcpTupleNotification"] = 11] = "PlainTransport_RtcpTupleNotification";
    Body[Body["DirectTransport_RtcpNotification"] = 12] = "DirectTransport_RtcpNotification";
    Body[Body["Producer_ScoreNotification"] = 13] = "Producer_ScoreNotification";
    Body[Body["Producer_TraceNotification"] = 14] = "Producer_TraceNotification";
    Body[Body["Producer_VideoOrientationChangeNotification"] = 15] = "Producer_VideoOrientationChangeNotification";
    Body[Body["Consumer_LayersChangeNotification"] = 16] = "Consumer_LayersChangeNotification";
    Body[Body["Consumer_RtpNotification"] = 17] = "Consumer_RtpNotification";
    Body[Body["Consumer_ScoreNotification"] = 18] = "Consumer_ScoreNotification";
    Body[Body["Consumer_TraceNotification"] = 19] = "Consumer_TraceNotification";
    Body[Body["DataConsumer_MessageNotification"] = 20] = "DataConsumer_MessageNotification";
    Body[Body["DataConsumer_BufferedAmountLowNotification"] = 21] = "DataConsumer_BufferedAmountLowNotification";
    Body[Body["ActiveSpeakerObserver_DominantSpeakerNotification"] = 22] = "ActiveSpeakerObserver_DominantSpeakerNotification";
    Body[Body["AudioLevelObserver_VolumesNotification"] = 23] = "AudioLevelObserver_VolumesNotification";
...
function unionToBody(type, accessor) {
    switch (Body[type]) {
        ...
        case 'Transport_SctpNegotiatedCapabilitiesNotification': return accessor(new sctp_negotiated_capabilities_notification_1.SctpNegotiatedCapabilitiesNotification());
...
function unionListToBody(type, accessor, index) {
    switch (Body[type]) {
        ...
        case 'Transport_SctpNegotiatedCapabilitiesNotification': return accessor(index, new sctp_negotiated_capabilities_notification_1.SctpNegotiatedCapabilitiesNotification());
