...
import { Type } from '../../fbs/data-consumer/type';
...
export declare class DumpResponseT implements flatbuffers.IGeneratedObject {
    ...
    dataProducerPaused: boolean;
    subchannels: (number)[];
    constructor(id?: string | Uint8Array | null, dataProducerId?: string | Uint8Array | null, type?: Type, sctpStreamParameters?: SctpStreamParametersT | null, label?: string | Uint8Array | null, protocol?: string | Uint8Array | null, bufferedAmount?: number, bufferedAmountLowThreshold?: number, paused?: boolean, dataProducerPaused?: boolean, subchannels?: (number)[]);
