...
const type_1 = require("../../fbs/data-consumer/type");
...
class DumpResponse {
    ...
    static addBufferedAmount(builder, bufferedAmount) {
        builder.addFieldInt32(6, bufferedAmount, 0);
    }
    static addBufferedAmountLowThreshold(builder, bufferedAmountLowThreshold) {
        builder.addFieldInt32(7, bufferedAmountLowThreshold, 0);
    }
    ...
    static addDataProducerPaused(builder, dataProducerPaused) {
        builder.addFieldInt8(9, +dataProducerPaused, +false);
    }
    static addSubchannels(builder, subchannelsOffset) {
        builder.addFieldOffset(10, subchannelsOffset, 0);
    }
    ...
    static endDumpResponse(builder) {
        ...
        builder.requiredField(offset, 24); // subchannels
        return offset;
    }
    unpack() {
        return new DumpResponseT(this.id(), this.dataProducerId(), this.type(), (this.sctpStreamParameters() !== null ? this.sctpStreamParameters().unpack() : null), this.label(), this.protocol(), this.bufferedAmount(), this.bufferedAmountLowThreshold(), this.paused(), this.dataProducerPaused(), this.bb.createScalarList(this.subchannels.bind(this), this.subchannelsLength()));
    }
    unpackTo(_o) {
        _o.id = this.id();
...
class DumpResponseT {
    ...
    dataProducerPaused;
    subchannels;
    constructor(id = null, dataProducerId = null, type = type_1.Type.SCTP, sctpStreamParameters = null, label = null, protocol = null, bufferedAmount = 0, bufferedAmountLowThreshold = 0, paused = false, dataProducerPaused = false, subchannels = []) {
        this.id = id;
    ...
    pack(builder) {
        ...
        DumpResponse.addBufferedAmount(builder, this.bufferedAmount);
