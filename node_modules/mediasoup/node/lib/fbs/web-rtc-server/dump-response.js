...
class DumpResponse {
    ...
    static createDumpResponse(builder, idOffset, udpSocketsOffset, tcpServersOffset, webRtcTransportIdsOffset, localIceUsernameFragmentsOffset) {
...
class DumpResponseT {
    ...
    constructor(id = null, udpSockets = [], tcpServers = [], webRtcTransportIds = [], localIceUsernameFragments = []) {
        this.id = id;
    ...
    pack(builder) {
        ...
        return DumpResponse.createDumpResponse(builder, id, udpSockets, tcpServers, webRtcTransportIds, localIceUsernameFragments);
    }
}
