...
import { SctpNegotiatedCapabilities, SctpNegotiatedCapabilitiesT } from '../../fbs/sctp-association/sctp-negotiated-capabilities';
...
export declare class Dump implements flatbuffers.IUnpackableObject<DumpT> {
    ...
    sctpNegotiatedCapabilities(obj?: SctpNegotiatedCapabilities): SctpNegotiatedCapabilities | null;
    ...
    static addSctpNegotiatedCapabilities(builder: flatbuffers.Builder, sctpNegotiatedCapabilitiesOffset: flatbuffers.Offset): void;
...
export declare class DumpT implements flatbuffers.IGeneratedObject {
    ...
    sctpState: SctpState | null;
    sctpNegotiatedCapabilities: SctpNegotiatedCapabilitiesT | null;
    sctpListener: SctpListenerT | null;
    traceEventTypes: (TraceEventType)[];
    constructor(id?: string | Uint8Array | null, direct?: boolean, producerIds?: (string)[], consumerIds?: (string)[], mapSsrcConsumerId?: (Uint32StringT)[], mapRtxSsrcConsumerId?: (Uint32StringT)[], dataProducerIds?: (string)[], dataConsumerIds?: (string)[], recvRtpHeaderExtensions?: RecvRtpHeaderExtensionsT | null, rtpListener?: RtpListenerT | null, maxSendMessageSize?: number, maxReceiveMessageSize?: number, sctpParameters?: SctpParametersT | null, sctpState?: SctpState | null, sctpNegotiatedCapabilities?: SctpNegotiatedCapabilitiesT | null, sctpListener?: SctpListenerT | null, traceEventTypes?: (TraceEventType)[]);
